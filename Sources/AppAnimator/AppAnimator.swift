...
//  House
//
//  Created by Hanan Ahmed on 23/12/2022.
...
public class AppAnimator {
    ...
    public class func showAnimationFromUrl(FromUrl url: String, animationBackgroundView: UIView, removeFromSuper: Bool = true, loopMode: LottieLoopMode = .playOnce, contentMode: UIView.ContentMode = .scaleAspectFit, animationPrepared:LottieAnimation.DownloadClosure?=nil, completion: @escaping (Bool) -> ()) {
